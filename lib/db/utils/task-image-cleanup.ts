...
const SIMPLE_TARGETS: SimpleTarget[] = [
  ...
  { table: 'setoran_tasks', dateColumn: 'date', photoColumns: ['resi_photo', 'atm_card_selfie_photo', 'cashier_photo'] },
  { table: 'setoran_money_storage', dateColumn: 'date', photoColumns: ['resi_photo', 'atm_card_selfie_photo', 'cashier_photo'] },
